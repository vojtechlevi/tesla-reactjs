  ...
  return (
    <>
      ...
      <div
        ...
        className={`absolute top-0 left-0 w-full h-1/2 bg-white flex justify-center  items-center z-20 transform transition-all duration-500 ease-in-out ${className}`}
      >
